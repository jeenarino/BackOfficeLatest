...
namespace CheckinPortalGrabber.Models.Local
{
    ...
    public class OperaReservation
    {
        ...
        //public List<FolioItemsModel> FolioItems { get; set; }
        //public bool IsTaxInclusive { get; set; }
        //public List<ProfileList> ProfileList { get; set; }
        //public List<ResPreferance> ReservationPreferances { get; set; }
        //public List<ResPackage> ReservationPackages { get; set; }
        //public List<UserdefinedFIelds> UserDefinedFields { get; set; }
        //public List<ResAlerts> ReservationAlerts { get; set; }
        //public List<ReservationList> SharerReservations { get; set; }
        //public bool? IsPrimary { get; set; }
